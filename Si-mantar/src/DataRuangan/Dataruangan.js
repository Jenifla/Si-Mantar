...
const Dataruangan = () => {
    ...
    const fetchDataJurusan = async () => {
        try {
            ...
            console.log("data jurusan:",response.data);
        } catch (error) {
    ...
    const filteredData = ruangan.filter((ruangan) => {
        const jurusan = jurusans.find(j => j.id === parseInt(ruangan.jurusan_id))?.nama_jurusan.toLowerCase();
        return (
    ...
    const AddDataRuangan = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://127.0.0.1:8000/api/ruangans', formData, {
                headers: {
    ...
    const DeleteDataRuangan = async () => {
        try {
            await axios.delete(`http://127.0.0.1:8000/api/ruangans/${ruanganData.id}`);
            setShowDelete(false);
            fetchDataRuangan();
            // window.location.reload();
    ...
    const UpdateDataRuangan = async (e) => {
        ...
        try {
            const response = await axios.put(`http://127.0.0.1:8000/api/ruangans/update/${ruanganData.id}`, updatedRuanganData, {
                headers: {
                                    ...
                                    <tbody>
                                        {currentData.length > 0 ?(
                                            ...
                                            <tr key={ruangan.id}>
                                                ...
                                                <td>{jurusans.find(j => j.id === parseInt(ruangan.jurusan_id))?.nama_jurusan}</td>
