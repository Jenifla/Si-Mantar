...
const FormPermintaan = () => {
    ...
    const handleScan = (data) => {
        ...
        if (kodeBarangValue && namaBarangValue && jenisBarang) {
            ...
            if (jenisBarang.toLowerCase() === "barang inventaris") {
      ...
      const handleError = (err) => {
        ...
        const fetchDataBarang = async () => {
            try {
                const response = await axios.get('http://127.0.0.1:8000/api/barangs/bhp');
