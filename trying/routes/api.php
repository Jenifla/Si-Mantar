...
Route::group(['middleware' => 'api', 'prefix' => 'peminjamans'], function () {
    ...
    Route::get('/getA', [PeminjamanController::class, 'getDiajukan']);
    Route::get('/getT', [PeminjamanController::class, 'getTunggu']);
    Route::get('/getP', [PeminjamanController::class, 'getPersetu']);
    Route::get('/getR', [PeminjamanController::class, 'getRiwayat']);
    Route::get('/getK', [PeminjamanController::class, 'getKembali']);
    Route::get('/getif', [PeminjamanController::class, 'Notifications']);
